...
var VarImage = function VarImage(_ref) {
  ...
  })), currentValue == null || currentValue.src == null ? null : React__default.createElement("div", {
...
var VarVector3 = function VarVector3(_ref) {
  ...
  var inputRefX = React.useRef(null);
  var inputRefY = React.useRef(null);
  var inputRefZ = React.useRef(null);

  var _useState = React.useState([0, 0, 0]),
      display = _useState[0],
      setDisplay = _useState[1];
  ...
  var handleInputBlurZ = React.useCallback(function (e) {
    handleInputBlur(e, 2);
  }, [handleInputBlur]);
  React.useEffect(function () {
  ...
  return React__default.createElement(VarBase, {
    ...
    className: "react-var-ui-vector-wrapper"
  }, React__default.createElement("span", null, "Z"), React__default.createElement("input", {
    className: "react-var-ui-vector-input",
    type: "number",
    ref: inputRefZ,
    min: min ? min[2] : min,
...
var VarAdd = function VarAdd(_ref) {
  ...
  var handleCloseClick = React.useCallback(function (_) {
...
var VarToggleGroup = function VarToggleGroup(_ref) {
  ...
  return React__default.createElement("div", null, React__default.createElement(VarBase, {
    ...
    className: "react-var-ui-toggle-helper"
  })))), !!children && !(toggleHidden && (!currentValue || false)) && React__default.createElement("div", {
    className: "react-var-ui-group"
  }, children));
};
...
exports.VarToggleGroup = VarToggleGroup;
exports.VarUI = VarUI;
